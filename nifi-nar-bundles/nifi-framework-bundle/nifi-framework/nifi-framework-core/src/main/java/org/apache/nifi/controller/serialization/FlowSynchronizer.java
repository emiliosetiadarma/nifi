...
public interface FlowSynchronizer {
     ...
     * @param handler used for the encryption/decryption of sensitive property values
     ...
     */
    void sync(FlowController controller, DataFlow dataFlow, PropertyValueHandler handler, FlowService flowService, BundleUpdateStrategy bundleUpdateStrategy)
