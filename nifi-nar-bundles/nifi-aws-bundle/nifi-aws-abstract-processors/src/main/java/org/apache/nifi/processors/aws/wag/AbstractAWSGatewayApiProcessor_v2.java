 ...
 */
public abstract class AbstractAWSGatewayApiProcessor_v2 extends
        AbstractAwsProcessor<, AwsDefaultClientBuilder> {
    ...
    public AbstractAWSGatewayApiProcessor_v2() {
    }

    public AbstractAWSGatewayApiProcessor_v2(final AmazonHttpClient client) {
