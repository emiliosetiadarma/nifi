...
public class StatelessProcessContextFactory implements ProcessContextFactory {
    ...
    public StatelessProcessContextFactory(final ControllerServiceProvider controllerServiceProvider, final PropertyValueHandler handler, final StateManagerProvider stateManagerProvider) {
    ...
    public ProcessContext createProcessContext(final Connectable connectable) {
        ...
        if (connectable instanceof ProcessorNode) {
            ...
            return new StandardProcessContext(processor, controllerServiceProvider, handler, stateManager, () -> false, NODE_TYPE_PROVIDER);
        }

        return new ConnectableProcessContext(connectable, handler, stateManager);
    }
}
